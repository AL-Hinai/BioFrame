...
urlpatterns = [
    ...
    path('workflow/<str:workflow_id>/open-file/', views.open_workflow_file, name='open_workflow_file'),
    path('download-file/', views.serve_file_download, name='serve_file_download'),
    ...
    path('workflow/<str:workflow_id>/container-status/', views.get_container_status, name='get_container_status'),
    path('workflow/<str:workflow_id>/files/', views.get_workflow_files, name='get_workflow_files'),
